...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#194C80' : '#194C80',
  brandInfo: '#356A9B',
  brandSuccess: '#5cb85c',
  brandDanger: '#B05B49',
  brandWarning: '#f0ad4e',
  ...
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#194C80',
  ...
  tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#194C80',
