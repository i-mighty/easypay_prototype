    ...
    render() {
        return (
            <ScrollView>
               ...
               {/*         <NBIcon name={'piggy-bank'} type={'FontAwesome5'} style={{color: materialColors.blackTertiary, fontSize: 60}}/>*/}
               {/*     </Row>*/}
               {/*     <Row style={{marginVertical: 10}}>*/}
               ...
               {/*     <Row style={{marginVertical: 10}}>*/}
               {/*         <Button light  block>*/}
               {/*             <NBText style={{...material.titleObject, color: materialColors.blackTertiary}}>*/}
